    ...
    return GestureDetector(
      ...
      child: Scaffold(
        body: Consumer<CustomViewModel>(builder: (context, state, child) {
          return Column(
            children: [
              appBar(context: context, title: "Add address", size: size),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomBtn(
                            size: size,
                            title: state.isLoading ? "Loading..." : "Save",
                            btnColor: state.isLoading ? Colors.black.withOpacity(0.5) : AppColors.primary,
                            radius: 10,
                            onTap: () async {
                              if (addressController.text.isNotEmpty && landmark.text.isNotEmpty) {
                                state.isLoading
                                    ? null
                                    : widget.isUpdate
                                        ? await Provider.of<CustomViewModel>(context, listen: false)
                                            .updateAddress(
                                              addressID: state.addressList[widget.index!].addressesId,
                                              address: addressController.text,
                                              landmark: landmark.text,
                                              addressesLat: latitude,
                                              addressesLong: longitude,
