...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void initState() {
    ...
    if (data.userStateid != '' && providerListener.stateList.isNotEmpty) {
      state.text =
          providerListener.stateList.singleWhere((element) => element.stateId == data.userStateid!).stateName ?? "";
    }
    if (data.userCityid != '' && providerListener.cityList.isNotEmpty) {
      city.text =
